...
test_words = training[205:]
test_labels = output[205:]
train_words = training[:205]
train_labels = output[:205]
...
model.fit(train_words, train_labels, epochs=400, validation_data=(test_words, test_labels),batch_size=34, verbose=2)
